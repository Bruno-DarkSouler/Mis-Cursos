<?php
    ...
    $libro = ConsultaSelect($conexion, "SELECT libro.id, libro.titulo FROM libro JOIN cursos ON cursos.ID_cursos = libro.id_curso WHERE cursos.ID_cursos = '$id_curso'");
    ...
    <main>
        ...
        <div id="libro">
            <?php
                echo
                "<h1>
                    Consulta el libro: ". $libro[0]["titulo"] ."
                </h1>
                <div>
